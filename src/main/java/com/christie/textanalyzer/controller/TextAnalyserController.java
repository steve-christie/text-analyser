...
public class TextAnalyserController {
    ...
    private String convertTextDetailIntoStringResponse(TextMetadata detail) {
        ...
        Map<Integer, Integer> sortedMap = new TreeMap<>(detail.getWordLengths());
        ...
        sortedMap.forEach((k, v) -> builder.append(String.format("Number of words of length %s is %s%n", k, v)));
